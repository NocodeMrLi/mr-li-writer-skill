...
<section style="background:#fffef8;border:2px solid #1a1a1a;box-shadow:4px 4px 0 #1a1a1a;margin-bottom:32px;">
  ...
  <section style="display:flex;">
    <section style="flex:1;min-width:0;box-sizing:border-box;padding:24px 20px;border-right:2px dashed #A7F3D0;word-break:break-word;overflow-wrap:anywhere;">
      <section style="font-size:24px;font-weight:900;color:#1a1a1a;letter-spacing:0.5px;margin-bottom:4px;text-shadow:0.5px 0 0 #1a1a1a;text-align:left;text-align-last:left;word-spacing:normal;white-space:normal;word-break:normal;overflow-wrap:anywhere;"><span leaf="">{{大标题}}</span></section>
...
| Markdown 表格 | 通用库 4 semantic-table，替换为本主题色 | 必须输出语义化 `<table>`；手机端 1～4 列自然换行且不横向滚动，5 列及以上才允许宽度有上限的局部滚动 |
